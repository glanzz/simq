...
use pyo3::prelude::*;
use ferriq_core::{Circuit as RustCircuit, DynamicCircuitBuilder};
use ferriq_gates::*;
use std::sync::Arc;
...
///
/// ```python
/// from ferriq import CircuitBuilder
///
...
/// ```
#[pyclass(name = "Circuit", module = "ferriq")]
...
impl PyCircuit {
    ...
    fn __str__(&self) -> String {
        ferriq_core::render_ascii(&self.inner)
    }
...
/// circuit = builder.build()
/// ```
#[pyclass(name = "CircuitBuilder", module = "ferriq")]
