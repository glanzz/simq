...
pyo3::create_exception!(
    ...
    QuantumException,
    PyException,
    "Base exception for Ferriq quantum operations"
);
pyo3::create_exception!(
    ferriq,
    InvalidQubitError,
...
pyo3::create_exception!(ferriq, InvalidGateError, QuantumException, "Invalid gate or gate operation");
pyo3::create_exception!(
    ferriq,
