//! Python bindings for Ferriq quantum computing SDK
//!
//! This crate provides Python bindings for the Ferriq quantum computing framework,
...
///
/// Ferriq is a Rust-based quantum computing framework with Python bindings,
...
#[pymodule]
fn _ferriq(_py: Python, m: &Bound<'_, PyModule>) -> PyResult<()> {
    // Add version information
    m.add("__version__", env!("CARGO_PKG_VERSION"))?;
    m.add("__author__", "Ferriq Contributors")?;
