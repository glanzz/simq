...
def test_local_simulator_basic_execution():
    ...
    backend = ferriq.LocalSimulatorBackend()
...
def test_local_simulator_with_config():
    ...
    config = ferriq.LocalSimulatorConfig(
        seed=42,
        max_qubits=20,
    ...
    backend1 = ferriq.LocalSimulatorBackend(config=config)
    backend2 = ferriq.LocalSimulatorBackend(config=config)
