...
///
/// ```ignore
/// use ferriq_sim::gradient::{compute_gradient_parameter_shift, ParameterShiftConfig};
///
...
mod tests {
    ...
    use ferriq_gates::standard::{Hadamard, RotationY};
    use ferriq_state::observable::PauliString;
    use std::sync::Arc;
