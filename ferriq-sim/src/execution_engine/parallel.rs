...
use ferriq_core::{Circuit, GateOp};
...
mod tests {
    ...
    fn no_op_gate_fn(_gate_op: &ferriq_core::GateOp, _state: &mut AdaptiveState) -> Result<()> {
        Ok(())
    }
    ...
    fn test_layer_based_propagates_gate_error() {
        ...
        let error_gate_fn = |_gate_op: &ferriq_core::GateOp, _state: &mut AdaptiveState| {
