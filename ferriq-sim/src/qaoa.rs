...
//!
//! ```ignore
//! use ferriq_sim::qaoa::{QAOACircuitBuilder, ProblemType, MixerType, Graph};
//!
...
use ferriq_gates::{CNot, Hadamard, PauliX, RotationX, RotationY, RotationZ, SGate, SGateDagger};
...
impl From<ferriq_core::QuantumError> for QAOAError {
