...
use ferriq_sim::gradient::autodiff::{gradient_forward, Dual, HybridAD};
use ferriq_sim::gradient::batch::{
    evaluate_batch_expectation, evaluate_multi_observable, grid_search,
};
use ferriq_sim::gradient::batch_advanced::{
    latin_hypercube_sampling, line_search, verify_gradients, AdaptiveBatchEvaluator, BatchConfig,
    ImportanceSampler,
};
use ferriq_sim::gradient::classical_optimizers::{LBFGSConfig, NelderMeadConfig};
use ferriq_sim::gradient::convergence::{
...
use ferriq_state::observable::{Pauli, PauliObservable, PauliString};
use std::sync::Arc;
