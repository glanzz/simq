...
fn print_plan_summary(plan: &ferriq_compiler::execution_plan::ExecutionPlan) {
    println!(
...
fn visualize_plan(plan: &ferriq_compiler::execution_plan::ExecutionPlan, circuit: &Circuit) {
