...
//! in Ferriq, showing how to decompose arbitrary quantum gates into various
//! basis gate sets used by different quantum hardware vendors.
//!
//! Run with: cargo run --package ferriq-compiler --example gate_decomposition

use ferriq_compiler::decomposition::{
...
fn main() {
    println!("=== Ferriq Gate Decomposition Examples ===\n");
...
fn clifford_t_example() {
    ...
    // T-count and T-depth
    use ferriq_compiler::decomposition::clifford_t::CliffordTGate;
