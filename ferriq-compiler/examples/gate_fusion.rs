...
use ferriq_gates::standard::{Hadamard, PauliX, PauliY, PauliZ, RotationX, RotationZ, SGate, TGate};
use std::sync::Arc;
...
fn example_mixed_circuit() {
    ...
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::CNot) as Arc<dyn Gate>, &[q0, q1])
        .unwrap();
