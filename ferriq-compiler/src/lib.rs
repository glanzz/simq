//! Circuit optimization and compilation for Ferriq
//!
...
//!
//! ```ignore
//! use ferriq_compiler::{CompilerBuilder, passes::*};
...
//!
//! ```ignore
//! use ferriq_compiler::decomposition::{DecompositionConfig, BasisGateSet, UniversalDecomposer};
//!
...
//!
//! ```ignore
//! use ferriq_compiler::CircuitAnalysis;
//! use ferriq_core::Circuit;
//!
//! // Analyze a circuit
...
//!
//! ```ignore
//! use ferriq_compiler::adaptive_pipeline::AdaptiveCompiler;
//! use ferriq_core::Circuit;
//!
...
//!
//! ```ignore
//! use ferriq_compiler::hardware_aware::{HardwareType, CostModel};
//! use ferriq_core::Circuit;
//!
//! let circuit = Circuit::new(3);
...
//!
//! ```ignore
//! use ferriq_compiler::{CachedCompiler, pipeline::{create_compiler, OptimizationLevel}};
//! use ferriq_core::Circuit;
//!
...
//!
//! ```ignore
//! use ferriq_compiler::execution_plan::ExecutionPlanner;
//! use ferriq_core::Circuit;
//!
