...
fn test_template_hzh_to_x() {
    ...
    let mut circuit = Circuit::new(1);
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::Hadamard), &[q(0)])
        .unwrap();
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::PauliZ), &[q(0)])
        .unwrap();
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::Hadamard), &[q(0)])
        .unwrap();
...
fn test_template_hxh_to_z() {
    ...
    circuit
        ...
        .unwrap();
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::PauliX), &[q(0)])
        .unwrap();
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::Hadamard), &[q(0)])
        .unwrap();
...
fn test_template_no_match_across_qubits() {
    ...
    circuit
        ...
        .unwrap();
    circuit
        .add_gate(Arc::new(ferriq_gates::standard::PauliX), &[q(1)])
        .unwrap();
