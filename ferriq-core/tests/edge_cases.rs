//! Edge case and error path tests for ferriq-core
...
mod noise_edge_cases {
    ...
    fn kraus_operator_invalid_dimension() {
        use ferriq_core::noise::KrausOperator;
...
mod validation_edge_cases {
    use super::*;
    use ferriq_core::validation::dag::DependencyGraph;
    use ferriq_core::validation::rules::*;
