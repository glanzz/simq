//! Core types and traits for Ferriq quantum computing SDK
//!
...
//!
//! ```
//! use ferriq_core::{CircuitBuilder, Gate};
//! use std::sync::Arc;
//!
//! # #[derive(Debug)]
//! # struct HGate;
...
//!
//! ```
//! use ferriq_core::{DynamicCircuitBuilder, Gate};
//! use std::sync::Arc;
//!
//! # #[derive(Debug)]
//! # struct HGate;
...
/// Type alias for results in Ferriq
