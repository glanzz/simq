...
Ferriq provides a powerful and flexible system for creating, managing, and manipulating custom quantum gates. This guide covers all aspects of the custom gates feature, from basic creation to advanced usage patterns.
...
```rust
use ferriq_gates::custom::CustomGateBuilder;
...
```rust
use ferriq_core::circuit_builder::CircuitBuilder;
use std::sync::Arc;
...
```rust
use ferriq_gates::custom::ParametricCustomGateBuilder;
...
```rust
use ferriq_gates::gate_registry::GateRegistry;
...
```rust
use ferriq_gates::custom::CustomGateError;
...
- [Circuit Builder](../ferriq-core/docs/circuit_builder.md)
