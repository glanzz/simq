//! Quantum gate library for Ferriq
//!
...
//! - **Type-safe gate interface**: All gates implement the `Gate` trait from `ferriq-core`
...
//!
//! ```
//! use ferriq_gates::standard::{Hadamard, CNot, RotationX};
//! use ferriq_gates::matrices;
...
//!
//! ```
//! use ferriq_gates::optimized::{create_global_lookup_table, OptimizedRotationX};
//!
