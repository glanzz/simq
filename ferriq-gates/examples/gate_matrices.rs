...
//!
//! This example showcases how Ferriq pre-computes common quantum gate matrices
//! at compile time for optimal performance.

use ferriq_core::gate::Gate;
use ferriq_gates::{matrices, standard::*, CNot, Hadamard, PauliX};
...
fn main() {
    println!("===========================================");
    println!("Ferriq: Compile-time Gate Matrix Computation");
    println!("===========================================");
