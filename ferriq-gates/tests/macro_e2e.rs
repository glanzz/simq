mod rx_cache {
    ferriq_macros::cached_rotations!(RX, 0.0, 0.5, 1.0, 1.5707963267948966);
}

mod ry_cache {
    ferriq_macros::cached_rotations!(RY, 0.0, 1.0, 3.141592653589793);
}

mod rz_cache {
    ferriq_macros::cached_rotations!(RZ, 0.0, 0.5, 1.5707963267948966);
}

mod rx_range {
    ferriq_macros::cache_rotation_range!(RX, 0.0, 1.5707963267948966, 10);
}

mod ry_range {
    ferriq_macros::cache_rotation_range!(RY, 0.0, 3.141592653589793, 5);
}

mod rz_range {
    ferriq_macros::cache_rotation_range!(RZ, 0.0, 1.5707963267948966, 8);
}
...
mod tests {
    ...
    // ===== Cross-validation with ferriq-gates =====

    #[test]
    fn test_rx_cache_matches_ferriq_gates() {
        use ferriq_gates::matrices::{rotation_x, rotation_y, rotation_z};
    ...
    #[test]
    fn test_rx_uncached_matches_ferriq_gates() {
        use ferriq_gates::matrices::rotation_x;
    ...
    #[test]
    fn test_ry_uncached_matches_ferriq_gates() {
        use ferriq_gates::matrices::rotation_y;
    ...
    #[test]
    fn test_rz_uncached_matches_ferriq_gates() {
        use ferriq_gates::matrices::rotation_z;
    ...
    #[test]
    fn test_range_rx_matches_ferriq_gates() {
        use ferriq_gates::matrices::rotation_x;
