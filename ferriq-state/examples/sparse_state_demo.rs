//! SparseState implementation example showcasing Phase 2.1 of Ferriq development plan
//!
...
use ferriq_state::SparseState;

fn main() {
    println!("=== Ferriq SparseState Implementation (Phase 2.1) ===\n");
