...
//!
//! ```ignore
//! use ferriq_state::{MonteCarloSimulator, MonteCarloConfig};
//! use ferriq_core::noise::DepolarizingMC;
//!
...
use ferriq_core::noise::{MonteCarloSampler, PauliOperation};
...
mod tests {
    use super::*;
    use ferriq_core::noise::{DepolarizingMC, PhaseDampingMC};
    ...
    fn test_amplitude_damping_mc_noise_increments_counter() {
        use ferriq_core::noise::AmplitudeDampingMC;
