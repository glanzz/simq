...
use ferriq_state::simd::diagonal::apply_diagonal_gate_scalar;
use ferriq_state::simd::single_qubit::apply_gate_scalar;
use ferriq_state::simd::{apply_diagonal_gate, apply_single_qubit_gate, norm_simd};
use ferriq_state::{DenseState, StateVector};
