...
use ferriq_core::{Circuit, GateOp, QubitId};
use ferriq_gates::{CNot, PauliX, RotationX, RotationZ, SXGate, CZ};
...
mod tests {
    ...
    use ferriq_gates::{Hadamard, PauliZ, TGate};
