...
//!
//! ```ignore
//! use ferriq_backend::ibm_quantum::{IBMQuantumBackend, IBMConfig};
...
impl IBMQuantumBackend {
    ...
    /// Convert Ferriq circuit to OpenQASM 3.0
    ///
...
mod tests {
    ...
    mod circuit_to_qasm_tests {
        ...
        use ferriq_gates::standard::{CNot, Hadamard};
        use std::sync::Arc;
        ...
        fn errors_instead_of_dropping_unmapped_gate() {
            ...
            circuit
                .add_gate(Arc::new(ferriq_gates::standard::RotationZ::new(0.5)), &[QubitId::new(0)])
                .unwrap();
