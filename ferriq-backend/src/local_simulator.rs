...
//!
//! This module provides a backend implementation that wraps the Ferriq local
//! simulator (ferriq-sim) to provide execution through the unified backend API.
//!
//! # Features
//!
...
//!
//! ```no_run
//! use ferriq_backend::local_simulator::LocalSimulatorBackend;
//! use ferriq_backend::QuantumBackend;
...
/// Local simulator backend using ferriq-sim
...
mod tests {
    use super::*;
    use ferriq_core::CircuitBuilder;
    use ferriq_gates::standard::PauliX;
    use std::sync::Arc;
    ...
    fn simple_circuit() -> ferriq_core::Circuit {
        let mut circuit = CircuitBuilder::<2>::new();
        circuit
            .apply_gate(Arc::new(PauliX), &[circuit.qubits()[0]])
            .unwrap();
    ...
    fn test_sample_measurements_with_superposition() {
        ...
        use ferriq_gates::standard::Hadamard;
