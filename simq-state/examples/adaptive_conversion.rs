...
fn main() {
    ...
    for qubit in 0..10 {
        ...
        println!("   After H on qubit {}: {} | Density: {:.2}% | Memory: {} entries",
                 qubit,
    ...
    println!("   After 3 Hadamards: {} | Density: {:.2}%",
    ...
    println!("   Sparse: {} bytes ({} amplitudes)",
             sparse_memory,
    ...
    println!("   Dense:  {} bytes ({} amplitudes)",
             dense_memory,
             dense_state.dimension());
