...
//! simulator, which is the workload Ferriq optimizes for.

use criterion::{criterion_group, criterion_main, BenchmarkId, Criterion, Throughput};
use ferriq::{Pauli, PauliObservable, PauliString, QuantumCircuit, SimulatorConfig};
...
/// Ferriq's compile-time gate caches for common angles do NOT kick in and
