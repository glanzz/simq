//! Comprehensive cross-crate integration tests for the Ferriq quantum SDK
//!
...
use ferriq_compiler::pipeline::{create_compiler, OptimizationLevel};
...
fn deterministic_execution_across_backends() {
    let config = ferriq_backend::LocalSimulatorConfig {
        seed: Some(42),
        ..Default::default()
    };
